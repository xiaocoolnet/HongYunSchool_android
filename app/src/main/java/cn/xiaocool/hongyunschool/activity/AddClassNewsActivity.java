...
public class AddClassNewsActivity extends BaseActivity {
    ...
    private void setAddImgGrid() {
        localImgGridAdapter = new LocalImgGridAdapter(mPhotoList, AddClassNewsActivity.this);
    ...
    private void showActionSheet() {
        ActionSheet.createBuilder(AddClassNewsActivity.this, getSupportFragmentManager())
    ...
    private void sendNews() {
        ...
        if (photoWithPaths.size()==0){
            new SendRequest(AddClassNewsActivity.this,handler).send_class_new(
                    ...
                    "标题", addsnContent.getText().toString(), id, "null", ADD_KEY);
            return;
        }
        //上传图片成功后发布
        new PushImageUtil().setPushIamge(this, photoWithPaths, new PushImage() {
            ...
            @Override
            public void error() {
                ToastUtil.showShort(AddClassNewsActivity.this, "图片上传失败!");
            }
        });
    }
    ...
    public void onClick() {
        ...
        Intent intent = new Intent(AddClassNewsActivity.this, ChooseReciverActivity.class);
    ...
    private GalleryFinal.OnHanlderResultCallback mOnHanlderResultCallback = new GalleryFinal.OnHanlderResultCallback() {
        ...
        public void onHanlderFailure(int requestCode, String errorMsg) {
            Toast.makeText(AddClassNewsActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
        }
    };
