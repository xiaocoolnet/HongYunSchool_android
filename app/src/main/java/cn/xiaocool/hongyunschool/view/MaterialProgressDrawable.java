...
import cn.xiaocool.hongyunschool.utils.DensityUtil;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
	...
	private final int[] COLORS = new int[] { 0xFFC93437, 0xFF375BF1,
			0xFFF7D23E, 0xFF34A350 };
	/**
	...
	private void setUp(final double diameter) {
		final int shadowYOffset = DensityUtil.dip2px(mParent.getContext(),
				Y_OFFSET);
		final int shadowXOffset = DensityUtil.dip2px(mParent.getContext(),
				X_OFFSET);
		int mShadowRadius = DensityUtil.dip2px(mParent.getContext(),
				SHADOW_RADIUS);
		...
		mShadow.getPaint().setShadowLayer(mShadowRadius, shadowXOffset,
