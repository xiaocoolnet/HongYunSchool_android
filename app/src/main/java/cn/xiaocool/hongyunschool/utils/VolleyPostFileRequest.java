 ...
 */
public class VolleyPostFileRequest extends StringRequest {
    private Part[] parts;

    public VolleyPostFileRequest(String url, Part[] parts, Response.Listener<String> listener, Response.ErrorListener errorListener) {
